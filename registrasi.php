...
<head>
    ...
    <title> Verifikasi Registrasi Siswa</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Verifikasi Registrasi Siswa</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <?php foreach ($db as $regis): ?>
                                    ...
                                    <td>
                                    <a href="verif_regis.php?id=<?php echo $regis['noinduk_siswa'];?>" class="btn btn-success btn-block btn-sm ">Verifikasi</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                                </tbody>

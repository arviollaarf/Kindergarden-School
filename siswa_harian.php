        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4"> Nilai Harian Siswa</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>                              
                                    <?php
                                    $ambil = $conn->query("SELECT * FROM nilai_harian");
                                    ?>
                                    <?php while ($row = $ambil->fetch_assoc()) {    ?>
                                        <tr>
                                            <td><?php echo $row['id_nilai_harian']; ?></td>
                                            <td><?php echo $row['noinduk_siswa']; ?></td>
                                           
                                            <td><?php echo $row['tgl_ambil_nilai']; ?></td>
                                            
                                            <td>
                                            <a href="detail-nilai-harian.php?id=<?php echo $row['id_nilai_harian']; ?>" class="btn btn-warning">Lihat Nilai</a>
                                            </td>
                                        </tr>
                                    <?php } ?>

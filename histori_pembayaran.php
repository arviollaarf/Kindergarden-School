        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4"> Histori Pembayaran Siswa</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php
                                    $ambil = mysqli_query($conn, "SELECT * FROM siswa as a join pembayaran as b
                                            on (a.noinduk_siswa=b.noinduk_siswa) WHERE status_bayar ='1'");
                                    while ($data = mysqli_fetch_array($ambil)) {
                                        $noinduk_siswa = $data['noinduk_siswa'];
